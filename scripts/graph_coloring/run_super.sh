...
# ---------- supers: no external packages needed (pure list-based coloring) ----------
unset SUPERS_INJECT_FILE 2>/dev/null || true
unset SUPERS_GHC_PACKAGES 2>/dev/null || true
echo "[sup ] pure Haskell supers (no extra packages)"
