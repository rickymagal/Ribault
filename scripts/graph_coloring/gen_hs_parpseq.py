...
parColorDC :: [(Int, Int)] -> [(Int, Int)]
parColorDC [] = []
parColorDC [x] = [colorChunk x]
parColorDC xs =
  let mid = length xs `div` 2
      (left, right) = splitAt mid xs
      leftRes  = parColorDC left
      rightRes = parColorDC right
  in leftRes `par` (rightRes `pseq` leftRes ++ rightRes)
