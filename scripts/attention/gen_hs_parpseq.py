#!/usr/bin/env python3
"""Generate GHC par/pseq attention .hs (file IO via BS.readFile)."""
...
-- Auto-generated: Attention GHC par/pseq (file IO via BS.readFile)
...
"""
    with open(path, "w", encoding="utf-8") as f:
        f.write(src)
    print(f"[gen_attn_pp] wrote {path} (N={N}, D={D}, n_funcs={len(ranges)})")
