...
DEFAULT_CSV = "results/nqueens_paper_final/master.csv"
DEFAULT_OUT = "results/nqueens_paper_final/tables_with_ci.txt"
...
def main():
    ...
    out = []
    out.append(f"N-QUEENS — median speedup with 95% bootstrap CI ({B} independent resamples)")
